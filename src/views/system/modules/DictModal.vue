  ...
  >
    <a-form :form="form">
      ...
      <a-form-item
        ...
        label="字典名称"
      >
        <a-input placeholder="字典名称" v-decorator="['dictName', {rules: [{ required: true, message: '请输入字典名称' },{ min: 1, max: 100, message: '长度在 1 到 100 个字符', trigger: 'blur' }]}]" />
      </a-form-item>
      ...
      <a-form-item
        ...
        label="字典类型"
      >
        <a-input v-decorator="['dictType',{rules: [{ required: true, message: '请输入字典类型' },{ min: 1, max: 100, message: '长度在 1 到 100 个字符', trigger: 'blur' }]}]" placeholder="字典类型"/>
      </a-form-item>
